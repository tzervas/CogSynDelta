...
class UnifiedAlgebraicTrainer:
    ...
    def _optimize_mhc_modules(self, train_x: Tensor) -> dict[str, Any]:
        """Optimize mHC modules.

        Args:
            train_x: Training inputs.

        Returns:
            mHC optimization results.
        """
    ...
    def _optimize_pathway_strengths(self) -> dict[tuple[str, str], float]:
        """Optimize pathway strengths.

        Returns:
            Optimal pathway strengths.
        """
        pathway_strengths: dict[tuple[str, str], float] = {}
    ...
    def train_algebraically(
        ...
        # mHC optimization
        mhc_res = self._optimize_mhc_modules(train_x)
        if mhc_res:
            results["mhc_analysis"] = mhc_res

        # Pathway optimization
        pathway_res = self._optimize_pathway_strengths()
        if pathway_res:
            results["optimal_pathway_strengths"] = pathway_res
