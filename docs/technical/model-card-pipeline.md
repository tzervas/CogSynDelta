...
|---|---|---|
| undocumented metric | `CardError` (`require_documented`, `src/cogsyndelta/cards/methodology.py:816`) | a receipt carries a metric key with no entry in `METRIC_METHODOLOGY` — no stated formula/battery/source to print beside it |
