...
class ProgressiveLoadingConfig:
    ...
    def from_yaml(cls, yaml_path: str | Path, profile: str = "base") -> ProgressiveLoadingConfig:
        ...
        Args:
            cls: ProgressiveLoadingConfig class reference.
...
class ProgressiveLoaderManager:
    ...
    def __init__(
        ...
        Args:
            ...
            interconnect: Intelligent interconnect manager instance.
            device: Target device name or string for model loading.
