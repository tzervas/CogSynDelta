...
- P1-02 https://git.vectorweight.com/tzervas/memory-gate/pulls/4 — `feat/public-error-contract` @ `f586dde`. Mapper + await-learn from main. Local trivy 0 HIGH. **Not merged** — wait Forgejo.
...
1. G-CI **met**. G-ERR PR #4 `f586dde`: wait legitimately green Forgejo (local trivy clean on cryptography 50.0.1). Do not merge red.
1b. After P1-02: P1-04 in-memory oracle.
