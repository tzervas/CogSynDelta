...
class UnifiedAlgebraicTrainer:
    ...
    def _optimize_auxiliary(self, train_x: Tensor, results: dict[str, Any]) -> None:
        """Optimize auxiliary components of the network.

        Args:
            train_x: Training inputs
            results: Results dictionary to be populated in-place
        """
        # mHC optimization
    ...
    def train_algebraically(
        ...
        self._optimize_auxiliary(train_x, results)
