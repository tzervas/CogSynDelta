...
- name: cogsyndelta-region-retrieve
  ...
  - task:
    ...
    - type: rank.candidates
      ...
      verified: false
    - type: rank.mrr
      value: 0.8302817344665527
      name: rank.mrr
      verified: false
    - type: rank.ndcg@10
      value: 0.8572322726249695
      name: rank.ndcg@10
      verified: false
    - type: rank.recall@1
      value: 0.755859375
    ...
    - type: rank.recall@5
      ...
      verified: false
    - type: repr.alignment
      value: 0.7781396508216858
      name: repr.alignment
      verified: false
    - type: repr.anisotropy
      value: 0.0021334135122307893
    ...
    - type: repr.effective_rank
      value: 159.72467041015625
      name: repr.effective_rank
      verified: false
    - type: repr.effective_rank_ratio
      value: 0.6239244937896729
      name: repr.effective_rank_ratio
      verified: false
    - type: repr.uniformity
      value: -3.860140562057495
      name: repr.uniformity
      verified: false
---

# CogSynDelta -- retrieve

`cc-by-nc-sa-4.0` · release `v0.1.0` · code revision `a7694090903664bc256b4b96d998b37cacd316cf` · metrics schema `csd-metrics/v1 (not recorded)` · repo `tzervas/cogsyndelta-region-retrieve`
...
`retrieve` region: the harness cell selected from the training matrix as the one
this region ships under `main.pt` / the region's Hub repo default revision.

**Parameters:** 16.021 M. **Role:** Query or claim -> passage rank.
...
- **Faculty, not a general model.** Triggered by: A query plus candidate passages.
...
this variant reaches 0.98 of the bag-of-words ceiling on 512 items (`csd-lexical/v1`).

### Training held-out battery

| metric | this variant | untrained baseline |
|---|---|---|
| `emb_std`[^1] | **0.062004** | 0.00710633 |
| `mrr`[^2] | **0.830282** | 0.0133101 |
| `n_pairs`[^3] | 512 | 512 |
| `recall@1`[^4] | **0.755859** | 0.00195312 |
| `recall@10`[^5] | **0.945312** | 0.0195312 |
...
| `rank.mrr`[^2] | 0.830282 | _(n/a)_ | 0.824976 |
| `rank.ndcg@10`[^10] | 0.857232 | _(n/a)_ | 0.848047 |
| `rank.recall@1`[^4] | 0.755859 | _(n/a)_ | 0.769531 |
| `rank.recall@10`[^5] | 0.945312 | _(n/a)_ | 0.923828 |
| `rank.recall@5`[^11] | 0.919922 | _(n/a)_ | 0.894531 |

### Efficiency (fp32)

| metric | this variant | untrained baseline |
|---|---|---|
| `eff.capability_per_mb`[^12] | 0.0117946 | _(n/a)_ |
| `eff.capability_per_param`[^13] | 0.0471786 | _(n/a)_ |
| `eff.latency_p50_ms`[^14] | 1.38346 | _(n/a)_ |
| `eff.latency_p95_ms`[^15] | 1.87117 | _(n/a)_ |
| `eff.latency_p99_ms`[^16] | 1.91563 | _(n/a)_ |
| `eff.parameters`[^17] | 1.60212e+07 | _(n/a)_ |
| `eff.peak_vram_mb`[^18] | 391.183 | _(n/a)_ |
| `eff.stored_mb`[^19] | 64.085 | _(n/a)_ |
| `eff.throughput_per_s`[^20] | 697.487 | _(n/a)_ |

### Representation (fp32)

| metric | this variant | untrained baseline |
|---|---|---|
| `repr.alignment`[^21] | 0.77814 | _(n/a)_ |
| `repr.anisotropy`[^22] | 0.00213341 | _(n/a)_ |
| `repr.dimensions`[^23] | 256 | _(n/a)_ |
| `repr.effective_rank_entropy`[^24] ^v1^ | 159.725 | _(n/a)_ |
| `repr.effective_rank_entropy_ratio`[^25] ^v1^ | 0.623924 | _(n/a)_ |
| `repr.uniformity`[^26] | -3.86014 | _(n/a)_ |
...
|---|---|---|---|
| `rank.candidates`[^9] | 512 | _(n/a)_ | _(n/a)_ |
| `rank.mrr`[^2] | 0.822247 | _(n/a)_ | 0.824976 |
| `rank.ndcg@10`[^10] | 0.851331 | _(n/a)_ | 0.848047 |
| `rank.recall@1`[^4] | 0.748047 | _(n/a)_ | 0.769531 |
| `rank.recall@10`[^5] | 0.945312 | _(n/a)_ | 0.923828 |
| `rank.recall@5`[^11] | 0.917969 | _(n/a)_ | 0.894531 |

### Efficiency (quantized artifact)

| metric | this variant | untrained baseline |
|---|---|---|
| `eff.capability_per_mb`[^12] | 0.0758796 | _(n/a)_ |
| `eff.capability_per_param`[^13] | 0.0466909 | _(n/a)_ |
| `eff.latency_p50_ms`[^14] | 1.3807 | _(n/a)_ |
| `eff.latency_p95_ms`[^15] | 1.72438 | _(n/a)_ |
| `eff.latency_p99_ms`[^16] | 1.72593 | _(n/a)_ |
| `eff.parameters`[^17] | 1.60212e+07 | _(n/a)_ |
| `eff.peak_vram_mb`[^18] | 196.003 | _(n/a)_ |
| `eff.stored_mb`[^19] | 9.85834 | _(n/a)_ |
| `eff.throughput_per_s`[^20] | 701.466 | _(n/a)_ |

### Representation (quantized artifact)

| metric | this variant | untrained baseline |
|---|---|---|
| `repr.alignment`[^21] | 0.780946 | _(n/a)_ |
| `repr.anisotropy`[^22] | 0.018628 | _(n/a)_ |
| `repr.dimensions`[^23] | 256 | _(n/a)_ |
| `repr.effective_rank_entropy`[^24] ^v1^ | 164.719 | _(n/a)_ |
| `repr.effective_rank_entropy_ratio`[^25] ^v1^ | 0.643435 | _(n/a)_ |
| `repr.uniformity`[^26] | -3.79838 | _(n/a)_ |

### Quantization (quant_plan battery)

| metric | this variant | untrained baseline |
|---|---|---|
| `fp32_metric_recomputed`[^27] | 0.755859 | _(n/a)_ |
| `quant.plan_recall@1`[^28] | 0.748047 | _(n/a)_ |
| `quant.drop_recall@1`[^29] | 0.0078125 | _(n/a)_ |
| `tolerance`[^30] | 0.01 | _(n/a)_ |
| `within_budget`[^31] | yes | _(n/a)_ |
| `quant.compression_ratio`[^32] | 6.50058 | _(n/a)_ |
| `fp32_bytes`[^33] | 64084992 | _(n/a)_ |
| `stored_bytes`[^34] | 9858344 | _(n/a)_ |
...
| weights on disk, csd-ptq-v1 | 9.858 MB | measured, `stored_bytes` |
| compression ratio (storage, not speed) | 6.5x | measured, `quant.compression_ratio` |
| bit-width histogram | 3-bit: 15, 5-bit: 1, 8-bit: 1 | measured, `width_histogram` |
| eval peak VRAM, fp32 | 391.183 MB | MEASURED, eval peak, eval batch 512, max_len 96 |
| eval peak VRAM, quantized | 196.003 MB | MEASURED, eval peak, eval batch 512, max_len 96 |
| training peak VRAM | 9822.000 MiB | MEASURED, training peak, batch 1280, max_len 96, cell retrieve-b1280-s1-7bc2699-20260904 |
...
# verify: sha256(final.pt) == "1351cf45944331b1cc63f94b234c3fc964341034660a624c362f3b5469909540"
```
...
```bash
python3 scripts/csd-benchmark.py --region retrieve --checkpoint final.pt
```
...
`cc-by-nc-sa-4.0` -- GooAQ (NC, accepted 2026-09-02) and Natural Questions / FiQA (CC BY-SA) are both present in the corpus as trained. See `docs/design/LICENCE-FOR-OPEN-WEIGHTS.md`, "Decision 2026-09-02".

## Provenance

- **Corpus fingerprint:** `af4bb36f6f5dcacd0bf7f211df6ef63a` (scheme `csd-corpus-fp/v2`)
- **Seed:** `0`
- **Code revision:** `a7694090903664bc256b4b96d998b37cacd316cf`
- **Checkpoint sha256:** `1351cf45944331b1cc63f94b234c3fc964341034660a624c362f3b5469909540`
- **Metrics schema:** `csd-metrics/v1 (not recorded)`
- **Files:**
  - `final.pt`: sha256 `1351cf45944331b1cc63f94b234c3fc964341034660a624c362f3b5469909540`
...
```bibtex
@misc{cogsyndelta-retrieve,
  title = {CogSynDelta -- retrieve region},
  author = {Zervas, Tyler},
  year = {2026},
